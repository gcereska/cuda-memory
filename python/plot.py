#!/usr/bin/env python3
"""
plot_with_global.py — cumulative ms, includes global allocator

Usage:
    python3 plot_with_global.py [csv_path] [output_dir]

Outputs:
    plots/08_cumulative_all_runs.png  — r1 dotted, r2 solid
    plots/09_cumulative_r2_only.png   — r2 only
"""
...
plot_cumulative(
    df_all,
    "Cumulative ms — r1 dotted / r2 solid (no device malloc)",
    "08_cumulative_all_runs.png",
)
plot_cumulative(
    df_r2,
    "Cumulative ms — r2 only (no device malloc)",
    "09_cumulative_r2_only.png",
)
